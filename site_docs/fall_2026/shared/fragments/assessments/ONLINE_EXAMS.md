...
- Students may receive different questions
...
- The exam opens on the current course assessment platform one hour after the review session begins.
- You have a 36-hour window to complete both parts.
- You may take the parts at any time within that window.
...
- Exams completed after the deadline lose 1 point.
- Significantly late exams may receive additional penalties.

Meeting the deadline reduces stress and prevents avoidable logistical problems.
